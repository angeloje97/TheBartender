...
namespace Architome
{
    ...
    public class AudioManager : MonoBehaviour
    {
        ...
        public AudioSource PlaySound(AudioClip clip, float volume = 1f)
        {
            ...
            var randomPitchOffset = UnityEngine.Random.Range(1 -pitchRandomRange, 1 +pitchRandomRange);
            ...
            foreach (AudioSource source in audioSources)
            {
                ...
                if (!source.isPlaying)
                {
                    ...
                    source.loop = false;
                    source.volume = volume;
                    source.pitch = randomPitchOffset;
                    source.Play();
        ...
        public AudioSource PlaySoundLoop(AudioClip clip, float maxLength = 0f, float volume = 1)
        {
            ...
            if (maxLength != 0)
            {
                ArchGeneric.Delay(() => { audioSource.Stop(); }, maxLength);
